<?php
  ...
  function getProfile($usrnm){
    ...
    $profile .=      '<button class="btn btn-info" id="userUpdateBtn" onclick="usernameInput()">Update</button>
                      ...
                      <div id="usernameError" class="hidden error">
    ...
    $profile .=       '<button class="btn btn-info" id="emailUpdateBtn" onclick="emailInput()">Update</button>
                       ...
                       <div id="emailError" class="hidden error">
                    ...
                    <div id="emptyPassError" class="hidden error">
                      <strong>ERROR: </strong>All Inputs Required
                    </div>
                    <div id="passMatchError" class="hidden error">
                      <strong>ERROR: </strong>Passwords Do Not Match
                    </div>
                    <div id="incorrectPass" class="hidden error">
                      <strong>ERROR: </strong>Incorrect Password
                    </div>
                    <div id="passUpdateSuccess" class="hidden good">
